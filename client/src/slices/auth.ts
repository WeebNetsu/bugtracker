...
export const { userSignupStarted, userSignupSuccess, userSignupFailed } = authSlice.actions;
 ...
 */
export const userSignup = (username: string, userSupabaseId: string) => async (dispatch: any) => {
    try {
